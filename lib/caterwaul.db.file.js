...
// filehandles and causing the HTTP server to bomb out.) Requests are serviced in the order made.
  ...
  let*[settings = caterwaul.util.merge({mode: 0755, filehandles: 128, memory_index: true}, options || {}),
  ...
  fn[id][id = id || unique_id(), let*[result = fn[x][x === undefined ? id : (x.constructor === String   ? index_append(x, id) :
